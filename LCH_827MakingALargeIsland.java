...
class LCH_827MakingALargeIsland {
    public static int largestIsland(int[][] grid) {
        ...
        // If there is no island 0 from grid, res should be the size of islands of first
        // color
        ...
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < n; j++) {
                if (grid[i][j] == 0) {
                    ...
                    // If current island is at the boundary, we add 0 to the set, whose value is 0
                    // in the map
