...
class LCH_1851MinimumIntervalToIncludeEachQuery {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(LCH_1851MinimumIntervalToIncludeEachQuery.minInterval(intervals, queries)));
    }
}